...
//            }
            ...
            // 如果登录失效，则不显示错误信息
            if (model.apiModel.result.integerValue == 1003) {
                complation(model.apiModel.result.integerValue, nil, data, nil, model.localErrorCode, model.success);
            } else {
                // 其它情况正常显示错误信息
                complation(model.apiModel.result.integerValue, errInfo, data, nil, model.localErrorCode, model.success);
            }
